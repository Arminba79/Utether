  ...
  return (
    ...
    >
      ...
      <section className=" container-fluid flex flex-wrap justify-center gap-6 bg-[#213A57]">
        ...
        {/* قیمت لحظه ای */}
        <div className="bg-[#f1262600] w-10/12 md:w-5/12 flex gap-3 items-center rounded-lg mt-5 h-28 shadow-md shadow-black hover:shadow-white transition duration-300  ">
        ...
        {/* تغیرات ۲۴ ساعته */}
        <div className="bg-[#44c42400] w-10/12 md:w-5/12 flex gap-3 items-center rounded-lg mt-5 h-28 shadow-md shadow-black hover:shadow-white transition duration-300  ">
        ...
        {/* تغیرات هفتگی */}
        <div className="bg-[#2663f100] w-10/12 md:w-5/12 flex gap-3 items-center rounded-lg mt-5 h-28 shadow-md shadow-black hover:shadow-white transition duration-300  ">
        ...
        {/* تغیرات ماهانه  */}
        <div className="bg-[#cc26f100] w-10/12 md:w-5/12 flex gap-3 items-center rounded-lg mt-5 h-28 shadow-md shadow-black hover:shadow-white transition duration-300  ">
          <i className="bx bx-calendar text-7xl ms-3  text-blue-500"></i>
          <span className="text-xl font-semibold text-white">
            تغیرات ماهانه :
          </span>
          <span className="text-xl font-semibold text-white">
          ٪ {Number(props.p.diff30d).toLocaleString("fa-IR")}
           ...
           {/* max & min 7 d */}
        <div className=" border shadow-sm shadow-white w-[10rem] rounded-lg   h-32 flex flex-col font-bold gap-5 items-center mt-10">
